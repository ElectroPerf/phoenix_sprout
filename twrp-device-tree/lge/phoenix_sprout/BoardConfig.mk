...
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 28962816 # This is the maximum known partition size, but it can be higher, so we just omit it
...
TARGET_KERNEL_CONFIG := phoenix_sprout_defconfig
